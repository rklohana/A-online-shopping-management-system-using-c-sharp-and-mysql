    ...
    public partial class vendorform : Form
    {
        ...
        {   
           ...
           await dc.conn.OpenAsync();
            ...
            com1.CommandText = "select v.vfname,s.stock,p.productid,p.pname,p.image,p.description,s.price from VENDOR v,PRODUCT p,SOLD_BY s where s.VENDOR_VENDORID=@id and s.PRODUCT_PRODUCTID=p.PRODUCTID and s.VENDOR_VENDORID=v.VENDORID;";
